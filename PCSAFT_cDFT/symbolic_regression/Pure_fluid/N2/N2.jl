...
p_gamma = scatter(
    ...
    label = "Train",
    markersize = 4,
    title = "Parity Plot for gamma — N2",
    legend = :topleft,
)
...
export_hall_of_fame_tex(
    ...
    digits=4,
    feature_map=Dict("F1" => "(1 - Tr)"),
    title="Surface tension correlations from symbolic regression — N2"
)
