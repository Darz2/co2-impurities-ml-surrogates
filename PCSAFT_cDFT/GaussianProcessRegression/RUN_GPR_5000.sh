...
echo "Samples    : 5000"
echo "Seed       : 555555555"
echo "Output dir : SLURM_GPR_residual_5000"
...
mkdir -p "SLURM_GPR_residual_5000"

papermill GPR.ipynb "SLURM_GPR_residual_5000/GPR_residual_output.ipynb" \
    -p OUTPUT_FOLDER        "SLURM_GPR_residual_5000" \
    -p SEED                 555555555                  \
