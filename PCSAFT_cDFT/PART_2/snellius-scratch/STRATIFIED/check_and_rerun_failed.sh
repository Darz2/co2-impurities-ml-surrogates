...
#SBATCH --gres=gpu:1
#SBATCH -o /scratch-shared/draju/PART_2/STRATIFIED/slurm-check-rerun-%j.out
...
OUTPUT_ROOT="/scratch-shared/draju/PART_2/STRATIFIED/OUTPUTS"
SEED_BUBBLE=50015
SEED_GAMMA=50005
