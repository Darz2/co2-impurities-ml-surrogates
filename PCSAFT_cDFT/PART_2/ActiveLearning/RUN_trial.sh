...
# Usage: sbatch RUN_trial.sh METHOD SIZE TRIAL
# e.g.:  sbatch RUN_trial.sh AL_MT N025 trial_00
#        sbatch RUN_trial.sh AL_MT N075 trial_09
#        sbatch RUN_trial.sh AL_ST N100 trial_19

METHOD="${1:?Usage: sbatch $0 METHOD SIZE TRIAL  (e.g. AL_MT N025 trial_00)}"
SIZE="${2:?Usage: sbatch $0 METHOD SIZE TRIAL  (e.g. AL_MT N025 trial_00)}"
TRIAL="${3:?Usage: sbatch $0 METHOD SIZE TRIAL  (e.g. AL_MT N025 trial_00)}"

echo "Job started at: $(date '+%F %T')"
echo "Method: ${METHOD}  Size: ${SIZE}  Trial: ${TRIAL}"
...
COMPOSITIONS_CSV="${METHOD}/OUTPUT/${SIZE}/${TRIAL}.csv"
...
OUTPUT_DIR="RESULTS/${METHOD}/${SIZE}/${TRIAL}/${ARRAY_JOB_ID}_${TASK_ID}"
