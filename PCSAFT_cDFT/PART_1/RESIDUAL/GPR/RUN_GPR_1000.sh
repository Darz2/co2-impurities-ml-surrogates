#!/bin/bash
#SBATCH --job-name=ML-GPR_residual-1000
...
echo "Samples    : 1000"
echo "Seed       : 111111111"
echo "Output dir : SLURM_GPR_residual_1000"
...
mkdir -p "SLURM_GPR_residual_1000"

papermill GPR.ipynb "SLURM_GPR_residual_1000/GPR_residual_output.ipynb" \
    -p OUTPUT_FOLDER        "SLURM_GPR_residual_1000" \
    -p SEED                 111111111                 \
    -p EXPERIMENT_MAX_SAMPLES 1000                    \
