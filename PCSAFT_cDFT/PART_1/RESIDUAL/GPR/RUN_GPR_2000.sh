#!/bin/bash
#SBATCH --job-name=ML-GPR_residual-2000
...
echo "Samples    : 2000"
echo "Seed       : 222222222"
echo "Output dir : SLURM_GPR_residual_2000"
...
mkdir -p "SLURM_GPR_residual_2000"

papermill GPR.ipynb "SLURM_GPR_residual_2000/GPR_residual_output.ipynb" \
    -p OUTPUT_FOLDER        "SLURM_GPR_residual_2000" \
    -p SEED                 222222222                  \
