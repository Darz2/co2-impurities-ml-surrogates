#!/bin/bash
#SBATCH --job-name=ML-GPR_residual-3000
...
echo "Samples    : 3000"
echo "Seed       : 333333333"
echo "Output dir : SLURM_GPR_residual_3000"
...
mkdir -p "SLURM_GPR_residual_3000"

papermill GPR.ipynb "SLURM_GPR_residual_3000/GPR_residual_output.ipynb" \
    -p OUTPUT_FOLDER        "SLURM_GPR_residual_3000" \
    -p SEED                 333333333                  \
    -p EXPERIMENT_MAX_SAMPLES 3000                     \
