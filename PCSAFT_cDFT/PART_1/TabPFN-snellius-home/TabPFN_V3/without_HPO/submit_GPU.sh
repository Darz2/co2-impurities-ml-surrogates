...
#SBATCH --mem=720G
#SBATCH --gres=gpu:4
#SBATCH -o /gpfs/home6/draju/A6/TabPFN_V3/without_HPO/slurm-calc-%j.out
...
cd /gpfs/home6/draju/A6/TabPFN_V3/without_HPO
...
OUTPUT_ROOT="/gpfs/home6/draju/A6/TabPFN_V3/without_HPO"
...
run_notebook 0 TabPFNBubble_Calc.ipynb TabPFNBubble_Calc SLURMBubble 50015 &
pid_bubble=$!

run_notebook 1 TabPFNDew_Calc.ipynb TabPFNDew_Calc SLURMDew 855015 &
pid_dew=$!

run_notebook 2 TabPFNGamma_Calc.ipynb TabPFNGamma_Calc SLURMGamma 50005 &
pid_gamma=$!
