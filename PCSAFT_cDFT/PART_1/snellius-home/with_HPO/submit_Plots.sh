...
#SBATCH -J Plot_TabPFN_HPO
#SBATCH -t 01:00:00
#SBATCH -p thin
#SBATCH -N 1
#SBATCH --ntasks=4
#SBATCH -o /gpfs/home6/draju/A6/TabPFN/with_HPO/slurm-plots-%j.out
...
cd /gpfs/home6/draju/A6/TabPFN/with_HPO
source /gpfs/home6/draju/A6/.A6/bin/activate

export MPLBACKEND=Agg

OUTPUT_ROOT="/gpfs/home6/draju/A6/TabPFN/with_HPO"
